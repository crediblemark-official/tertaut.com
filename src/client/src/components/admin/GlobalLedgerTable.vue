      ...
      <table class="w-full min-w-full text-left text-xs whitespace-nowrap border-b border-jetblack/15">
        ...
        <tbody class="divide-y divide-jetblack/15">
          ...
          >
            ...
            <td class="py-2.5 px-3 text-jetblack/70 font-mono text-[11px]">{{ tx.builderEmail }}</td>
            <td class="py-2.5 px-3 text-jetblack/70 font-mono text-[11px]">{{ tx.customerEmail }}</td>
            <td class="py-2.5 px-3 font-mono font-bold text-jetblack">Rp {{ tx.grossAmount.toLocaleString('id-ID') }}</td>
            <td class="py-2.5 px-3 font-mono font-bold text-[#996515]">Rp {{ tx.platformFee.toLocaleString('id-ID') }}</td>
            <td class="py-2.5 px-3 font-mono font-bold text-forest">Rp {{ tx.netAmount.toLocaleString('id-ID') }}</td>
