  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-jetblack/10 border-t border-b border-jetblack/10 py-6">
    ...
    <div class="pb-6 lg:pb-0 pr-0 lg:pr-6 space-y-3.5">
      ...
      <div class="space-y-3 text-xs">
        ...
        <div>
          <label class="block font-bold text-jetblack/70 mb-1">Penyedia AI (Provider)</label>
          <select
            v-model="newProvider"
            class="w-full h-9 bg-white border border-slate-300/80 hover:border-slate-400 rounded-lg px-2.5 text-xs text-jetblack font-bold shadow-2xs focus:ring-2 focus:ring-gold/20 focus:border-gold focus:outline-none transition"
          >
        ...
        <div>
          <label class="block font-bold text-jetblack/70 mb-1">API Key Rahasia</label>
          <input
            v-model="newRawKey"
            type="password"
        ...
        <div>
          <label class="block font-bold text-jetblack/70 mb-1">Batas Anggaran Bulanan (Rp)</label>
          <input
    ...
    <div class="pt-6 lg:pt-0 pl-0 lg:pl-6 space-y-3.5">
      <h2 class="text-sm font-bold text-jetblack">Status Vault &amp; Tombol Darurat</h2>
      ...
      <div v-else class="divide-y divide-jetblack/10">
        <div
