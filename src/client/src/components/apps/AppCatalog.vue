      ...
      <table class="w-full min-w-full text-left text-xs whitespace-nowrap border-b border-[#111111]/15">
        <thead class="border-b border-[#111111]/20 text-xs font-semibold text-[#111111]/70 bg-white">
          <tr>
            ...
            <th class="py-2.5 px-3">Tipe &amp; Harga</th>
            <th class="py-2.5 px-3">Delivery Fulfillment</th>
            <th class="py-2.5 px-3">Metering</th>
          ...
          <tr v-for="app in filteredApps" :key="app.id" class="hover:bg-[#111111]/[0.02] transition">
            ...
            <td class="py-2.5 px-3">
              <div class="flex items-center gap-1.5">
                ...
                >
                  {{ app.pricingType === 'subscription' ? (app.billingPeriod === 'yearly' ? 'Tahunan' : 'Bulanan') : app.pricingType === 'free' ? 'Gratis' : 'Sekali' }}
                </span>
              </div>
            </td>
            <td class="py-2.5 px-3">
              <div class="flex items-center gap-1">
                ...
                <span v-if="!app.deliveryConfig?.licenseKey?.enabled && !app.deliveryConfig?.fileDownload?.enabled && !app.deliveryConfig?.privateNote?.enabled" class="text-[#111111]/40 text-[10px]">
                  Standard
                </span>
              </div>
            </td>
