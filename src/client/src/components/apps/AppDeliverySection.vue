      ...
      <div class="p-3.5 rounded-xl border transition" :class="licenseEnabled ? 'bg-white border-jetblack/20 shadow-xs' : 'bg-jetblack/[0.02] border-jetblack/10 opacity-70'">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2.5">
            <div class="w-7 h-7 rounded-lg bg-gold/15 flex items-center justify-center text-jetblack">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <div class="w-8 h-4.5 bg-slate-200 rounded-full peer peer-checked:bg-forest transition-colors after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white peer-checked:after:bg-white after:rounded-full after:h-3.5 after:w-3.5 after:transition peer-checked:after:translate-x-full shadow-inner"></div>
          </label>
        </div>
        ...
        <div v-if="licenseEnabled" class="mt-3 pt-3 border-t border-jetblack/10 space-y-3">
          ...
          <div class="rounded-lg border p-2.5" :class="floatingEnabled ? 'bg-gold/5 border-gold/30' : 'bg-jetblack/[0.02] border-jetblack/10'">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="w-6 h-6 rounded-md bg-gold/15 flex items-center justify-center">
              ...
              <label class="relative inline-flex items-center cursor-pointer shrink-0">
                ...
                <div class="w-8 h-4.5 bg-slate-200 rounded-full peer peer-checked:bg-gold transition-colors after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white peer-checked:after:bg-white after:rounded-full after:h-3.5 after:w-3.5 after:transition peer-checked:after:translate-x-full shadow-inner"></div>
              </label>
            </div>
