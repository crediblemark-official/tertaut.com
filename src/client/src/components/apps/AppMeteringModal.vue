...
watch(
  ...
  (isOpen) => {
    if (isOpen) {
      ...
      meterFilters.value = props.initialFilters ? JSON.parse(JSON.stringify(props.initialFilters)) : []
      ...
      <div class="px-5 py-4 overflow-y-auto space-y-3.5 custom-modal-scrollbar text-xs">
        ...
        <div class="p-3 rounded-xl bg-slate-50 border border-slate-200/80 flex items-center justify-between">
          ...
          <div class="relative shrink-0">
            ...
            <div v-if="isTemplateDropdownOpen" @click="isTemplateDropdownOpen = false" class="fixed inset-0 z-40"></div>
            <div
            ...
            >
              <div class="px-2 py-1 text-[10px] uppercase font-bold text-slate-400 tracking-wider">Pilih Template</div>
              <button
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div class="relative">
            ...
            <div v-if="isCalcDropdownOpen" @click="isCalcDropdownOpen = false" class="fixed inset-0 z-40"></div>
            <div
        ...
        <div class="grid grid-cols-2 gap-3 pt-0.5">
          ...
          <div class="relative">
            ...
            <div v-if="isPerDropdownOpen" @click="isPerDropdownOpen = false" class="fixed inset-0 z-40"></div>
            <div
