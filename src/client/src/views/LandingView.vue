...
<template>
  ...
  >
    ...
    <header class="border-b border-jetblack/10 sticky top-0 bg-white/90 backdrop-blur-md z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <router-link to="/" class="flex items-center gap-2.5">
          <div
            class="w-8 h-8 rounded-lg bg-jetblack flex items-center justify-center font-bold text-white shadow-md relative overflow-hidden"
          >
        ...
        <nav class="hidden md:flex items-center gap-6 text-xs font-semibold text-jetblack/70">
          ...
          <router-link to="/dashboard/docs" class="hover:text-jetblack transition"
            >SDK & Docs</router-link
          >
          <a
            href="/swagger"
            target="_blank"
            class="hover:text-jetblack flex items-center gap-1 transition"
          >
      ...
      <div
        ...
        class="md:hidden border-t border-jetblack/10 bg-white px-4 py-3 space-y-2 text-xs font-semibold animate-fadeIn"
      >
        <a
          href="#fitur"
        ...
        <router-link
          ...
          @click="isMobileMenuOpen = false"
          class="block py-1.5 text-jetblack/80 hover:text-jetblack"
          >Coba Demo Paywall</router-link
        >
        <a href="/swagger" target="_blank" class="block py-1.5 text-jetblack/80 hover:text-jetblack"
          >Swagger API Docs ↗</a
        >
        <div class="pt-2 border-t border-jetblack/10">
          <router-link
            v-if="!isLoggedIn"
            to="/login"
            @click="isMobileMenuOpen = false"
            class="block py-2 text-center rounded-lg bg-jetblack text-white font-bold"
          >
            Masuk
          </router-link>
          <div v-else class="flex items-center gap-2">
            <router-link
              to="/dashboard"
              @click="isMobileMenuOpen = false"
              class="flex-1 py-2 text-center rounded-lg bg-jetblack text-white font-bold"
            >
              Buka Dashboard
            </router-link>
            <button
              ...
              "
              class="px-3 py-2 text-center rounded-lg border border-red-400/40 text-red-500 font-bold"
            >
              Keluar
            </button>
          </div>
    ...
    <!-- Hero Section -->
    <section
      class="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-24 border-b border-jetblack/10 bg-gradient-to-b from-white via-[#FAFAFA] to-[#F5F5F5]"
    >
      <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
        <!-- Top Pill Badge -->
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-jetblack/5 border border-jetblack/10 text-jetblack text-xs font-semibold"
        >
          <span class="w-2 h-2 rounded-full bg-forest animate-pulse"></span>
          <span class="font-mono text-[11px] text-jetblack/80"
            >Single Container Headless Engine v2.2</span
          >
        ...
        >
          Uji minat pasar sebelum coding, terima pembayaran instan via
          <strong>Merchant of Record DANA Enterprise</strong> (5% flat fee), lindungi software
          dengan <strong>Universal Licensing offline-first</strong>, dan amankan API AI Anda tanpa
          kebocoran kunci.
        </p>
        ...
        <div class="pt-4 max-w-md mx-auto">
          ...
          <div
            class="mt-2 text-[11px] text-jetblack/45 flex items-center justify-center gap-2 font-mono"
          >
          ...
          >
            ...
            >
              ...
              <div class="flex items-center rounded-lg bg-jetblack/5 p-0.5 text-xs font-semibold">
                <button
                  ...
                  :class="[
                    'px-2.5 py-1 rounded-md transition cursor-pointer text-xs',
            ...
            >
              ...
              >
                ...
                <p class="text-[11px] text-white/75 leading-relaxed">
                  Tidak perlu mendaftar PT/CV atau KYC Payment Gateway rumit. Uang masuk ke akun MoR
                  dan dicairkan otomatis 95% ke rekening Anda.
                </p>
                <router-link
                  to="/pay/fastmail-ai"
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-12 gap-5 items-center">
              ...
              >
                ...
                <p class="text-[11px] text-white/75 leading-relaxed">
                  Pasang tag <code>&lt;tertaut-badge&gt;</code> di website manapun tanpa merusak
                  gaya CSS host Anda.
                </p>
                <router-link
                  to="/dashboard/docs"
    ...
    <section id="fitur" class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 space-y-12">
      <div class="text-center space-y-3 max-w-2xl mx-auto">
        ...
        <p class="text-xs sm:text-sm text-jetblack/60">
          Dirancang untuk dijalankan mandiri (self-hosted) di atas Bun &amp; PostgreSQL dengan
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Modul 1 -->
        <div
          class="luxury-card rounded-2xl p-6 space-y-4 border border-jetblack/10 hover:border-jetblack/30 transition group"
        >
          <div
          ...
          <div class="space-y-1.5">
            <span class="text-[10px] font-bold uppercase tracking-wider text-jetblack/50 font-mono"
              >Modul 01</span
            >
            <h4 class="text-base font-bold text-jetblack">
              Dynamic Checkout &amp; MoR DANA Enterprise
            </h4>
            <p class="text-xs text-jetblack/65 leading-relaxed">
              Terima pembayaran QRIS, Virtual Account (BCA, Mandiri, BRI), dan E-Wallet tanpa perlu
              izin PT/CV. Merchant of Record dengan potongan flat 5% dan pencairan net 95% otomatis.
            </p>
          </div>
          <div
            class="pt-2 border-t border-jetblack/5 flex items-center justify-between text-xs font-semibold text-jetblack"
          >
            <router-link
              to="/dashboard/checkout"
              class="inline-flex items-center gap-1 hover:text-forest transition"
            >
              <span>Simulasi Checkout</span>
              <ChevronRight class="w-3.5 h-3.5 text-gold" />
            </router-link>
            <span class="text-[11px] font-mono text-forest bg-forest/10 px-2 py-0.5 rounded-md"
              >5% Flat Fee</span
            >
          </div>
        </div>
        ...
        >
          ...
          <div class="space-y-1.5">
            ...
            <p class="text-xs text-jetblack/65 leading-relaxed">
              Sistem proteksi lisensi multi-platform (Desktop Tauri/Electron, Web, Mobile, CLI).
              Dukungan offline grace period 30 hari via signed JWT dan hardware fingerprinting
              binding.
            </p>
          </div>
          <div
        ...
        >
          ...
          <div class="space-y-1.5">
            ...
            <p class="text-xs text-jetblack/65 leading-relaxed">
              Gateway AI multi-provider (OpenAI, Anthropic, Gemini, DeepSeek) dengan enkripsi
              AES-256. Mencegah kebocoran API key, rate limit 15 req/min, daily token cap, dan Zero
              Prompt Retention.
            </p>
          </div>
          <div
        ...
        >
          ...
          <div class="space-y-1.5">
            ...
            <p class="text-xs text-jetblack/65 leading-relaxed">
              Otomasi peluncuran produk: konversi live satu-klik, kupon early bird, dan embeddable
              web component badge.
            </p>
          </div>
          <div
        ...
        <div
          class="rounded-2xl p-6 space-y-4 bg-jetblack text-white flex flex-col justify-between shadow-xl"
        >
          <div class="space-y-2">
            <div
              class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-white/10 text-[10px] font-bold text-gold font-mono"
            >
              <span>ADMIN PANEL</span>
            </div>
            <h4 class="text-lg font-bold">Developer Command Center</h4>
            <p class="text-xs text-white/70 leading-relaxed">
              Pantau revenue kotor &amp; bersih, terbitkan lisensi, dan pantau penggunaan kuota AI
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div class="p-5 rounded-xl bg-white border border-jetblack/10 space-y-2 shadow-sm">
            ...
            <p class="text-xs text-jetblack/60 leading-relaxed">
              Eksekusi hingga 3-5x lebih cepat dibanding Node.js runtime dengan konsumsi RAM di
              bawah 80 MB saat idle.
            </p>
          </div>
          ...
          <div class="p-5 rounded-xl bg-white border border-jetblack/10 space-y-2 shadow-sm">
            ...
            <p class="text-xs text-jetblack/60 leading-relaxed">
              Database relasional yang kuat untuk data transaksi, idempotency key, lisensi hardware,
              dan log token AI.
            </p>
          </div>
          ...
          <div class="p-5 rounded-xl bg-white border border-jetblack/10 space-y-2 shadow-sm">
            ...
            <p class="text-xs text-jetblack/60 leading-relaxed">
              Kunci API penyedia AI dan token lisensi dienkripsi di level data store. Tanpa data
              teks polos tersimpan di log.
            </p>
          </div>
        </div>
      </div>
    ...
    <footer class="mt-auto border-t border-jetblack/10 bg-white py-10">
      <div
        class="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-jetblack/60"
      >
        <div class="flex items-center gap-2">
          <div
            class="w-6 h-6 rounded-md bg-jetblack flex items-center justify-center font-bold text-white text-[11px]"
          >
            T
          </div>
          <span class="font-extrabold text-jetblack font-mono"
