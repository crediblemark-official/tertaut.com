 ...
 */
async function authorizeLicense(
  licenseKey: string,
...
async function handleCreditBalance({ body, set, request }: any) {
  const { licenseKey, hwid } = body;
...
async function handleConsumeCredits({ body, set, request }: any) {
...
async function handleCreditHistory({ body, set, request }: any) {
